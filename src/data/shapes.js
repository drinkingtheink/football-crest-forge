...
export const shapes = [
  ...
  },
  {
    id: 'sh-scalloped',
    label: 'Scalloped',
    path: 'M 22,35 C 22,22 30,14 40,22 C 48,14 60,14 76,22 C 84,14 92,12 100,18 C 108,12 116,14 124,22 C 140,14 152,14 160,22 C 170,14 178,22 178,35 L 178,152 C 178,195 144,218 100,228 C 56,218 22,195 22,152 Z',
  },
  {
    id: 'sh-arch',
    label: 'Arch Top',
  ...
  },
  {
    id: 'sh-stepped',
    label: 'Stepped',
    path: 'M 22,22 L 178,22 L 178,88 L 158,88 L 158,155 C 158,196 138,216 100,227 C 62,216 42,196 42,155 L 42,88 L 22,88 Z',
  },
  {
    id: 'sh-chalice',
    label: 'Chalice',
    path: 'M 30,22 L 170,22 C 188,22 194,46 190,76 C 185,112 158,122 148,148 C 138,175 132,198 100,228 C 68,198 62,175 52,148 C 42,122 15,112 10,76 C 6,46 12,22 30,22 Z',
  },
